안녕하세요 WEB 웹퍼블리싱 및 프론트 개발자 문태연입니다.
...
클래스명을 각각 명확하게 알아볼수있게 선언하고 css 문제발생시 빠른 해결을 위해 important는 되도록 사용하지 않으려고 노력합니다.
          <div class="news">
            <div class="news_category">
              <div class="news_category_stand">stand</div>
              <div class="news_category_edit">edit</div>
              <div class="news_category_entertain">entertain</div>
          </div>
